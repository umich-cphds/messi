...
This `R` package tits the MESSI, hard constraint, and unconstrained models in Boss 
et al. (2023) <arXiv:2306.17347> for mediation analyses with external summary-level information on the total effect.
